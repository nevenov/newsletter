...
div.front_wrapper {
	...
	font-family:<?php echo $OptionsVis["gen_font_family"];?> !important; 
...
.image_grid {
	...
	if($OptionsVis["summ_image_ratio"]=="43") {
		...
		$ratio = 56;
	} elseif($OptionsVis["summ_image_ratio"]=="11") {
		$ratio = 100;
	} 
	?>
    padding-bottom : <?php echo $ratio; ?>%; /* = width for a 1:1 aspect ratio */
...
.news_title_grid { 
	color:<?php echo $OptionsVis["summ_title_color"];?>;
...
.news_title_grid:hover { 
	color:<?php echo $OptionsVis["summ_title_color_hover"];?>;
	font-family:<?php echo $OptionsVis["summ_title_font"];?> !important;
	font-size:<?php echo $OptionsVis["summ_title_size"];?> !important;
	font-weight:<?php echo $OptionsVis["summ_title_font_weight"];?> !important;
	font-style:<?php echo $OptionsVis["summ_title_font_style"];?> !important;
...
.news_short_descr { 
	color:<?php echo $OptionsVis["summ_color"];?>; 
	font-family:<?php echo $OptionsVis["summ_font"];?> !important; 
	font-size:<?php echo $OptionsVis["summ_size"];?> !important;
	font-style: <?php echo $OptionsVis["summ_font_style"];?> !important;
	text-align:<?php echo $OptionsVis["summ_text_align"];?> !important;
	line-height:<?php echo $OptionsVis["summ_line_height"];?> !important;
}
...
div.dist_menu_title {
	...
	padding:0; 
	margin:0 !important;
	padding-bottom: <?php echo $OptionsVis["dist_menu_title"];?> !important;
}
/* "back link" style start */
div.back_link {
	text-align:<?php echo $OptionsVis["link_align"]; ?> !important;
}
...
.arrow-left {
	...
	border-right: 4px solid <?php echo $OptionsVis["link_color"]; ?> !important; 
...
.arrow-left:hover {
	...
	border-top: 4px solid transparent !important; 
	border-bottom: 4px solid transparent !important; 
	border-right: 4px solid <?php echo $OptionsVis["link_color_hover"]; ?> !important; 
	display: inline-block !important; 
	margin-top: 1px !important; 
}
div.back_link_dist { /* distance between back link and other content */
	clear:both !important; 
	height:<?php echo $OptionsVis["back_link_dist"];?> !important;
}
/* back link style end */
...
div.date_style {
	color:<?php echo $OptionsVis["date_color"];?>; 
	font-family:<?php echo $OptionsVis["date_font"];?>; 
...
div.date_style span.catLine {
	...
	font-size:<?php echo $OptionsVis["cat_size"];?> !important;
	font-weight:<?php echo $OptionsVis["cat_font_weight"];?> !important; 
	font-style:<?php echo $OptionsVis["cat_font_style"];?> !important; 
}
...
div.img_caption { /* image caption underneath the image */
	color:<?php echo $OptionsVis["capt_color"];?> !important;
	font-family:<?php echo $OptionsVis["capt_font"];?> !important;
	font-size:<?php echo $OptionsVis["capt_size"];?> !important;
	font-weight:<?php echo $OptionsVis["capt_font_weight"];?> !important;
	font-style:<?php echo $OptionsVis["capt_font_style"];?> !important;
	text-align:<?php echo $OptionsVis["capt_text_align"];?> !important;
	background-color:<?php echo $OptionsVis["capt_bgr_color"];?> !important;
	padding: 2px 5px;
	word-wrap:break-word !important;
}
...
div.dist_btw_news { 
	clear:both !important; 
	height: <?php echo $OptionsVis["dist_btw_news"];?> !important;
	margin: 0 !important;
	padding: 0 !important;
	line-height:0 !important; 
	font-size:0 !important; 
