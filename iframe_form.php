...
if (isset($_POST["act"]) and $_POST["act"]=='subscribeNewsletter' and $Options['captcha']!='nocap') {
	$SysMessage = "";
...
if(isset($_REQUEST["act"]) and $_REQUEST["act"]=="subscribeNewsletter"){
	...
	if ($Options['captcha']=='nocap') $testvariable = true;
...
?>
<div class="form_wrapper_popup">
	 
    
    <!-- POPUP HEADING START HERE -->
    <?php if(trim($OptionsLang["popup_heading"])!="") { ?>
  	<div class="popup_heading">
    <?php echo $OptionsLang["popup_heading"]; ?>
    </div>
	<?php } ?>
    <!-- POPUP HEADING END HERE -->
    
    <!-- POPUP DESCRIPTION START HERE -->
    <?php if(trim($OptionsLang["popup_descr"])!="") { ?>
  	<div class="popup_descr">
    <?php echo $OptionsLang["popup_descr"]; ?>
    </div>
	<?php } ?>
    <!-- POPUP DESCRIPTION END HERE -->
	...
	<table class="table_form_popup" border="0">
        ...
        <?php include( dirname(__FILE__). "/include/incl_popup_form.php"); ?>
	</form>
